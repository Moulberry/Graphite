...
impl <T: PathNodeTraverser> PathFinder<T> {
    ...
    pub fn find_path_using_cost(&mut self, start: (i32, i32, i32),  max_iteration: usize, cost: impl Fn(i32, i32, i32) -> f32) -> Path {
        // todo: https://stackoverflow.com/questions/41297236/a-whats-the-best-data-structure-for-the-open-list
        ...
        while let Some(holder) = binary_heap.pop() {
            ...
            for successor in &successors {
                ...
                let estimated_cost = new_cost + cost(successor.x, successor.y, successor.z);
